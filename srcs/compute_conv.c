...
/*   Updated: 2017/03/13 20:53:46 by lchety           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	compute_conv_c (t_print *dna, va_list ap)
{
	char c;
	char *tmp;
	if (dna->cast_l)
	...
	//if c est un 0 alors print avec un ft_putstr qui
	//imprime un 0 et pas 2...
